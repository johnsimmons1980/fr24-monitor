...
echo "5. If installer fails: Try './fr24_manager.sh stop-web' then reinstall"
echo "6. Try manual start: lighttpd -D -f lighttpd.conf"
echo ""
echo "💡 Web Server Management Commands:"
echo "   ./fr24_manager.sh start-web    - Start web server"
echo "   ./fr24_manager.sh stop-web     - Stop web server"
echo "   ./fr24_manager.sh restart-web  - Restart web server"
